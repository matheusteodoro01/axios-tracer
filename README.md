...
```bash
npm install @gsc/axios-logger-client axios
```
...
```typescript
import { HttpClient } from '@gsc/axios-logger-client';
...
```typescript
import { HttpClient, Logger } from '@gsc/axios-logger-client';
